...
KUNLUN Chips of Generation 2: 
    ...
    - `Instruction on installing the Paddle KUNLUN Generation 2 version <./paddle_install_cn.html>`_ : Instruction on installing the Paddle KUNLUN Generation 2 version (R200, R300) 
    - `Example of training on the Paddle KUNLUN Generation 2 version <./train_example_cn.html>`_ : Example of training on the Paddle KUNLUN Generation 2 version (R200, R300) 
...
KUNLUN Chips of Generation 1: 
    ...
    - `Instruction on installing the Paddle KUNLUN Generation 1 version <./paddle_install_cn.html>`_ : Instruction on the Paddle KUNLUN Generation 1 version (K100, K200)
    - `Example of training on the Paddle KUNLUN Generation 1 version <./train_example_cn.html>`_ : Example of training on the Paddle KUNLUN Generation 1 version (K100, K200) 
